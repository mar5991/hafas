...
string clickout()
{
	...
	cin.getline(abc, 100000);
	cout<<"ZAZ "<<roz1[0]<<" "<<roz1[1]<<" dur hur"<<endl;
	cin.getline(abc, 100000);
	vector <string> roz2=rozdziel(abc);
	return roz2[1];
}

string scal(vector <string> lol)
{
	string wyn;
...
int main(int argc, char** argv)
{
	...
	vector <string> clicktmp;
	for(int i=0; i<20; i++)
	{
		clicktmp.push_back(clickout());
	}
	string strtec=scal(clicktmp);
	for(int i=0; i<100; i++)
	{
		cout<<"UTAG1 rrr"<<endl;
		cin.getline(abc, 100000);
		...
		cin.getline(abc, 100000);
		cout<<"SPEC # @ KE1 # SPP @ X11_color_alfa 255"<<endl;
		cin.getline(abc, 100000);
		...
		cout<<"SPP "<<ss1<<" X11_set yes"<<endl;
		cin.getline(abc, 100000);
		cout<<"ZWWW /home/marcin/programowanie/cpp/ProjektyWłasne/TOR-POLECENIA/dfs tabula rrr tak"<<endl;
		cin.getline(abc, 100000);
		cout<<"ZWWW /home/marcin/programowanie/cpp/ProjektyWłasne/TOR-POLECENIA/kolorowanie9 tabula "<<strtec<<endl;
		cin.getline(abc, 100000);
